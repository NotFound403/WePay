...
public class KoubeiMarketingDataBizadviserMyreportQueryResponse extends AlipayResponse {
	...
	/** 
	 * 不同uniq_key 返回不同参数，详细请看：<a href="https://doc.open.alipay.com/docs/doc.htm?spm=0.0.0.0.1Zq3by&docType=1&articleId=107061&previewCode=F30AA2D06B7CC0817AC7221A8CE288A4">参考文档</a>。
	 */
	@ApiField("result")
